(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-o374y3t4cyg',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","button[aria-label^=\"Quantity\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["button[data-action=\"remove-from-cart\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":["button[data-action=\"clear-cart\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["a[href^=\"/wishlist\"]","button[data-action=\"add-to-wishlist\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["cart_items"],
            contextCollection: {"search_parents":["a[href^=\"/cart\"]"],"extract_fields":["cart_items"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'UserMenu',
            type: 'custom',
            selectors: ["[data-action=\"user-menu\"]"],
            purpose: 'Accessing user-related actions (login, logout, profile)',
            contextNeeded: ["user_id","user_name"],
            contextCollection: {"search_parents":["[data-action=\"user-menu\"]"],"extract_fields":["user_id","user_name"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-o374y3t4cyg');
