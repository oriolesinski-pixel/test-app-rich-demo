(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-o0g16i2lec',
      ...
      this.componentDetectors = [
...

        {
            ...
            type: 'selector',
            selectors: ["[data-action=\"update-quantity\"]","button[aria-label^=\"Quantity\"]"],
            purpose: 'Adjusting product quantity',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","button[aria-label^=\"Quantity\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action"]}
        },

        {
            name: 'RemoveFromCart',
            type: 'button',
            selectors: ["button[data-action=\"remove-from-cart\"]"],
            purpose: 'Removing items from the cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["button[data-action=\"remove-from-cart\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action"]}
        },

        {
            name: 'ClearCart',
            type: 'button',
            selectors: ["button[data-action=\"clear-cart\"]"],
            purpose: 'Clearing the entire cart',
            contextNeeded: [],
            contextCollection: {"search_parents":["button[data-action=\"clear-cart\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":["data-action"]}
        },
...

        {
            ...
            type: 'custom',
            selectors: [".carousel"],
            purpose: 'Displaying a rotating carousel of product images',
            contextNeeded: ["product_id","product_image"],
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["product_id","product_image"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":["button[onClick^=\"setMobileMenuOpen\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":["onClick"]}
        },

        {
            name: 'WishlistButton',
            type: 'icon',
            selectors: ["a[href^=\"/wishlist\"]","button[data-action=\"add-to-wishlist\"]"],
            purpose: 'Adding/removing items from the wishlist',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["a[href^=\"/wishlist\"]","button[data-action=\"add-to-wishlist\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action"]}
        },

        {
            ...
            purpose: 'Accessing the shopping cart',
            contextNeeded: [],
            contextCollection: {"search_parents":["a[href^=\"/cart\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'UserMenu',
            type: 'custom',
            selectors: ["div[className*=\"user-menu\"]"],
            purpose: 'Accessing user-related actions (login, logout, profile)',
            contextNeeded: ["user_id","user_name"],
            contextCollection: {"search_parents":["div[className*=\"user-menu\"]"],"extract_fields":["user_id","user_name"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-o0g16i2lec');
