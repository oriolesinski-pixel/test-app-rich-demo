(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-04-pgu4dakme6f',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":[""]}
        },

        {
            ...
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId","quantity"]}
        },

        {
            ...
            contextCollection: {"search_parents":[".cart-item"],"extract_fields":["productId"]}
        },
...

        {
            ...
            type: 'button',
            selectors: [".bg-blue-600.text-white.py-3.rounded-lg.hover:bg-blue-700.transition-colors"],
            purpose: 'Submit the order',
            contextNeeded: ["shippingInfo","paymentInfo","items","total"],
            contextCollection: {"search_parents":[".checkout"],"extract_fields":["shippingInfo","paymentInfo","items","total"]}
        },

        {
            name: 'PrevSlideButton',
            type: 'button',
            selectors: ["button.absolute.left-4.top-1/2.-translate-y-1/2.bg-white/30.hover:bg-white/50.text-white.p-2.rounded-full.backdrop-blur-sm.transition-colors"],
            purpose: 'Navigate to the previous carousel slide',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["currentSlide"]}
        },

        {
            name: 'NextSlideButton',
            type: 'button',
            selectors: ["button.absolute.right-4.top-1/2.-translate-y-1/2.bg-white/30.hover:bg-white/50.text-white.p-2.rounded-full.backdrop-blur-sm.transition-colors"],
            purpose: 'Navigate to the next carousel slide',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["currentSlide"]}
        },

        {
            name: 'SlideIndicator',
            type: 'selector',
            selectors: ["button.w-2.h-2.rounded-full.transition-all"],
...

        {
            ...
            contextNeeded: ["productId"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId"]}
        },

        {
            ...
            contextCollection: {"search_parents":[""],"extract_fields":["itemCount"]}
        },

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":[""],"extract_fields":[""]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-04-pgu4dakme6f');
      console.log('📊 Tracking 16 discovered components');
