(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-04-c4uil413von',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Collect payment information and process order',
...

        {
            name: 'Carousel',
            type: 'custom',
            selectors: [".relative.w-full.h-\\[400px\\].md:h-\\[500px\\].overflow-hidden.rounded-lg",".absolute.inset-0.transition-transform.duration-500.ease-in-out",".absolute.left-4.top-1/2.-translate-y-1/2.bg-white/30.hover:bg-white/50.text-white.p-2.rounded-full.backdrop-blur-sm.transition-colors",".absolute.right-4.top-1/2.-translate-y-1/2.bg-white/30.hover:bg-white/50.text-white.p-2.rounded-full.backdrop-blur-sm.transition-colors",".absolute.bottom-4.left-1/2.-translate-x-1/2.flex.gap-2"],
...

        {
            ...
            type: 'icon',
            selectors: [".relative.text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Open the cart',
            contextNeeded: ["itemCount"],
            contextCollection: {"search_parents":[],"extract_fields":["itemCount"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'LoginLogoutToggle',
            type: 'custom',
            selectors: [".flex.items-center.space-x-3",".text-sm.text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Login or logout',
            contextNeeded: ["user","isAuthenticated"],
            contextCollection: {"search_parents":[],"extract_fields":["user","isAuthenticated"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-04-c4uil413von');
