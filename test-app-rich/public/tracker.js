(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-7jthjkj6mer',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Triggering actions like adding to cart, toggling wishlist, etc.',
            contextNeeded: ["product_id","selected_state"],
            contextCollection: {"search_parents":["button","[role=\"button\"]","[data-action]"],"extract_fields":["product_id","selected_state"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'QuantitySelector',
            type: 'selector',
            selectors: ["[data-testid=\"quantity-input\"]","[data-testid=\"quantity-button\"]"],
            purpose: 'Adjusting the quantity of a product in the cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-testid=\"quantity-input\"]","[data-testid=\"quantity-button\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'ColorSelector',
            type: 'selector',
            selectors: ["[data-testid=\"color-swatch\"]"],
            purpose: 'Selecting the color of a product',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-testid=\"color-swatch\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'SizeSelector',
            type: 'selector',
            selectors: ["[data-testid=\"size-button\"]"],
            purpose: 'Selecting the size of a product',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-testid=\"size-button\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'WishlistButton',
            type: 'button',
            selectors: ["[data-testid=\"wishlist-button\"]"],
            purpose: 'Adding or removing a product from the wishlist',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-testid=\"wishlist-button\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'CartButton',
            type: 'button',
            selectors: ["[data-testid=\"cart-button\"]"],
            purpose: 'Adding a product to the shopping cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-testid=\"cart-button\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":["form[action^='/auth/register']"],"extract_fields":["name","email","password"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'CheckoutForm',
            type: 'form',
            selectors: ["form[action^='/checkout']"],
            purpose: 'Completing the checkout process',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":["form[action^='/checkout']"],"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Carousel',
            type: 'custom',
            selectors: ["[data-testid=\"carousel\"]"],
            purpose: 'Displaying a rotating carousel of product promotions',
            contextNeeded: ["carousel_items"],
            contextCollection: {"search_parents":["[data-testid=\"carousel\"]"],"extract_fields":["carousel_items"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-7jthjkj6mer');
