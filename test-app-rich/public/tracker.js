(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-04-3m8esppvh9w',
      ...
      this.componentDetectors = [
        {
            ...
            purpose: 'Login, Register, Continue Shopping',
            contextNeeded: ["email","password","name"],
            contextCollection: {"search_parents":[".product-card","[data-product]","form"],"extract_fields":["email","password","name"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            purpose: 'Navigate to login, register, continue shopping',
            contextNeeded: [],
...

        {
            name: 'PaymentForm',
            type: 'form',
            selectors: [".space-y-4",".w-full.px-4.py-2.border.rounded-lg"],
...

        {
            ...
            purpose: 'Navigate to product pages, control carousel',
...

        {
            name: 'Header',
            type: 'custom',
            selectors: [".bg-white.shadow-sm.sticky.top-0.z-50",".flex.items-center.justify-between.h-16",".hidden.md:flex.items-center.space-x-6",".hidden.md:flex.items-center.space-x-4",".md:hidden.text-gray-700"],
            purpose: 'Navigate to pages, open mobile menu, login/logout',
            contextNeeded: ["itemCount","user","isAuthenticated"],
            contextCollection: {"search_parents":[],"extract_fields":["itemCount","user","isAuthenticated"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-04-3m8esppvh9w');
