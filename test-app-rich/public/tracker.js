(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-cz32ihbneo',
      ...
      this.componentDetectors = [
        {
            ...
            contextCollection: {"search_parents":[".product-card","[data-product]","form"],"extract_fields":["email","password","name","confirmPassword"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId","quantity"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":[".checkout"],"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextCollection: {"search_parents":[".checkout"],"extract_fields":["cardNumber","cardName","expiryDate","cvv","saveCard"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextNeeded: ["slideIndex"],
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["slideIndex"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextNeeded: ["productId"],
            contextCollection: {"search_parents":[".product-card"],"extract_fields":["productId"],"sibling_context":[],"data_attributes":[]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-cz32ihbneo');
