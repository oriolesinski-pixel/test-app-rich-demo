(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-rreh4nv0pc',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","[data-product-id]"],"extract_fields":["product_id","selected_state"],"sibling_context":[],"data_attributes":["data-product-id","data-action"]}
        },

        {
            name: 'Add to Cart',
            type: 'button',
            selectors: ["[data-action=\"add-to-cart\"]"],
            purpose: 'Adding products to the cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"add-to-cart\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action"]}
        },

        {
            name: 'Wishlist',
            type: 'icon',
            selectors: ["[data-action=\"toggle-wishlist\"]"],
            purpose: 'Adding/removing products from the wishlist',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"toggle-wishlist\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action"]}
        },
...

        {
            name: 'Checkout',
            type: 'custom',
            selectors: ["form[action=\"/checkout/payment\"]"],
            purpose: 'Checkout process',
            contextNeeded: ["shipping_info","payment_info"],
            contextCollection: {"search_parents":["form[action=\"/checkout/payment\"]"],"extract_fields":["shipping_info","payment_info"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-rreh4nv0pc');
