(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-bv8qonbl5fe',
      ...
      this.componentDetectors = [
...

        {
            ...
            type: 'custom',
            selectors: [".carousel"],
            purpose: 'Navigating carousel slides',
            contextNeeded: ["selected_state"],
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form[onSubmit=\"handleSubmit\"]"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":[]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-bv8qonbl5fe');
