(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-0xaxsmqdvxtg',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":["button","[role=\"button\"]","[data-action]"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextNeeded: ["selected_state"],
            contextCollection: {"search_parents":["select"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["selected_state"],
            contextCollection: {"search_parents":["input[type=\"checkbox\"]"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            purpose: 'Option selection',
            contextNeeded: ["selected_state"],
            contextCollection: {"search_parents":["input[type=\"radio\"]"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextNeeded: ["product_id","selected_state"],
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","[data-product-id]"],"extract_fields":["product_id","selected_state"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            name: 'Wishlist Button',
            type: 'icon',
            selectors: ["[data-action=\"add-to-wishlist\"]","[data-product-id]"],
            purpose: 'Add to wishlist',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"add-to-wishlist\"]","[data-product-id]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            name: 'Cart Button',
            type: 'icon',
            selectors: ["[data-action=\"add-to-cart\"]","[data-product-id]"],
            purpose: 'Add to cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"add-to-cart\"]","[data-product-id]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            name: 'Carousel',
            type: 'custom',
            selectors: [".carousel","[data-carousel]"],
            purpose: 'Image carousel',
            contextNeeded: ["selected_state"],
            contextCollection: {"search_parents":[".carousel","[data-carousel]"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Login Form',
            type: 'custom',
            selectors: ["form[action^='/auth/login']","form[onSubmit^='handleSubmit']"],
            purpose: 'User authentication',
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form[action^='/auth/login']","form[onSubmit^='handleSubmit']"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Register Form',
            type: 'custom',
            selectors: ["form[action^='/auth/register']","form[onSubmit^='handleSubmit']"],
            purpose: 'User registration',
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form[action^='/auth/register']","form[onSubmit^='handleSubmit']"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["form_data","cart_items"],
            contextCollection: {"search_parents":["form[onSubmit^='handleSubmit']"],"extract_fields":["form_data","cart_items"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["form_data","cart_items","shipping_info"],
            contextCollection: {"search_parents":["form[onSubmit^='handleSubmit']"],"extract_fields":["form_data","cart_items","shipping_info"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-0xaxsmqdvxtg');
