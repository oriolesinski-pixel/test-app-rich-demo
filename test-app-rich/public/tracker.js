(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-8tlo80nc8mr',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","button[aria-label^=\"Quantity\"]"],"extract_fields":["product_id","quantity"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            purpose: 'Navigating to the checkout page',
            contextNeeded: ["cart_items","total_amount"],
            contextCollection: {"search_parents":["a[href^=\"/checkout\"]"],"extract_fields":["cart_items","total_amount"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextNeeded: ["name","email","password","confirm_password"],
            contextCollection: {"search_parents":["form[action^=\"/auth/register\"]"],"extract_fields":["name","email","password","confirm_password"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            purpose: 'Navigating through a carousel of product promotions',
            contextNeeded: ["current_slide","total_slides"],
            contextCollection: {"search_parents":["[data-carousel]"],"extract_fields":["current_slide","total_slides"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-8tlo80nc8mr');
