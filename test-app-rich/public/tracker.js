(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-04-ozbzlz1mjjd',
      ...
      this.componentDetectors = [
        {
            ...
            purpose: 'Login, register, and other form submission actions',
            contextNeeded: ["email","password","name","confirmPassword"],
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["route"],
            contextCollection: {"search_parents":[],"extract_fields":["route"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'QuantitySelector',
            type: 'selector',
            selectors: [".flex.items-center.gap-2",".w-12.text-center"],
            purpose: 'Adjust product quantity in the cart',
            contextNeeded: ["productId","quantity"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId","quantity"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            ...
            contextCollection: {"search_parents":[".cart-item"],"extract_fields":["productId"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            type: 'form',
            selectors: [".space-y-4",".grid.grid-cols-2.gap-4",".w-full.px-4.py-2.border.rounded-lg"],
            purpose: 'Collect shipping information for the order',
...

        {
            name: 'PaymentForm',
            type: 'form',
            selectors: [".space-y-4",".w-full.px-4.py-2.border.rounded-lg",".flex.items-center.gap-2"],
            purpose: 'Collect payment information and process the order',
...

        {
            ...
            purpose: 'Display a carousel of featured products or promotions',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":[],"extract_fields":["currentSlide"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextCollection: {"search_parents":[],"extract_fields":["mobileMenuOpen"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["productId"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            name: 'CartToggle',
            type: 'icon',
            selectors: [".relative.text-gray-700.hover:text-blue-600.transition-colors",".absolute.-top-2.-right-2.bg-red-500.text-white.text-xs.rounded-full.w-5.h-5.flex.items-center.justify-center"],
            purpose: 'Open the cart or view the cart contents',
            contextNeeded: ["itemCount"],
            contextCollection: {"search_parents":[],"extract_fields":["itemCount"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'LoginToggle',
            type: 'icon',
            selectors: [".text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Open the login page',
            contextNeeded: [],
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'LogoutButton',
            type: 'button',
            selectors: [".text-sm.text-gray-700.hover:text-blue-600.transition-colors"],
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-04-ozbzlz1mjjd');
