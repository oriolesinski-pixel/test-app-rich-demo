(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-6668v2t8wre',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","[data-product-id]"],"extract_fields":["product_id","selected_state"],"sibling_context":[],"data_attributes":["data-action","data-product-id"]}
        },

        {
            ...
            contextCollection: {"search_parents":["[data-action=\"add-to-wishlist\"]","[data-product-id]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action","data-product-id"]}
        },

        {
            ...
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"add-to-cart\"]","[data-product-id]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action","data-product-id"]}
        },

        {
            ...
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form[action^='/auth/login']"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":["action"]}
        },

        {
            ...
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form[action^='/auth/register']"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":["action"]}
        },

        {
            ...
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form[action^='/checkout']"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":["action"]}
        },

        {
            ...
            contextNeeded: ["selected_state"],
            contextCollection: {"search_parents":["[data-component=\"Carousel\"]"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":["data-component"]}
        },

        {
            name: 'Logout Button',
            type: 'button',
            selectors: ["[data-action=\"logout\"]"],
            purpose: 'User logout',
            contextNeeded: [],
            contextCollection: {"search_parents":["[data-action=\"logout\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":["data-action"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-6668v2t8wre');
