(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-02-lc3xrna85a',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Triggering actions related to the icon',
            contextNeeded: [],
...

        {
            ...
            purpose: 'Adjusting the quantity of a product',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","button[aria-label^=\"Quantity\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action=\"update-quantity\""]}
        },

        {
            ...
            purpose: 'Removing a product from the cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["button[data-action=\"remove-from-cart\"]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-action=\"remove-from-cart\""]}
        },

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":["button[data-action=\"clear-cart\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":["data-action=\"clear-cart\""]}
        },
...

        {
            ...
            type: 'custom',
            selectors: [".carousel"],
            purpose: 'Displaying a rotating carousel of product images or promotions',
            contextNeeded: ["carousel_items"],
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["carousel_items"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'MobileMenuToggle',
            type: 'button',
            selectors: ["button[aria-label=\"Toggle mobile menu\"]"],
            purpose: 'Toggling the mobile navigation menu',
            contextNeeded: [],
            contextCollection: {"search_parents":["button[aria-label=\"Toggle mobile menu\"]"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-02-lc3xrna85a');
