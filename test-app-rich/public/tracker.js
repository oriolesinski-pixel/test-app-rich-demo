(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-04-z3z8hujntvc',
      ...
      this.componentDetectors = [
        {
            ...
            purpose: 'Login, register, and other form submission buttons',
...

        {
            ...
            purpose: 'Navigation links to other pages',
            contextNeeded: null,
...

        {
            name: 'IconButton',
            type: 'icon',
            selectors: [".p-1.hover:bg-gray-100.rounded",".text-red-500.hover:text-red-700",".relative.text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Cart item quantity control, remove from cart, and cart/wishlist icons',
            contextNeeded: ["productId","quantity"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId","quantity"],"sibling_context":null,"data_attributes":null}
        },

        {
            ...
            purpose: 'Form fields for login, registration, and checkout',
            contextNeeded: ["email","password","name","confirmPassword","firstName","lastName","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword","firstName","lastName","phone","address","city","state","zipCode","country"],"sibling_context":null,"data_attributes":null}
        },
...

        {
            ...
            type: 'icon',
            selectors: [".relative.text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Add/remove items from wishlist',
            contextNeeded: ["productId"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId"],"sibling_context":null,"data_attributes":null}
        },

        {
            ...
            purpose: 'Navigate to login/logout',
            contextNeeded: null,
            contextCollection: {"search_parents":null,"extract_fields":null,"sibling_context":null,"data_attributes":null}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-04-z3z8hujntvc');
      console.log('📊 Tracking 9 discovered components');
