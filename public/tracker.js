(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-01-4c9z00jrfhm',
      ...
      this.componentDetectors = [
        {
            name: 'Button',
            type: 'button',
            selectors: [".rounded-full.border.border-solid.border-transparent.transition-colors.flex.items-center.justify-center.bg-foreground.text-background.gap-2.hover:bg-[#383838].dark:hover:bg-[#ccc].font-medium.text-sm.sm:text-base.h-10.sm:h-12.px-4.sm:px-5.sm:w-auto",".rounded-full.border.border-solid.border-black\\/[.08].dark:border-white\\/[.145].transition-colors.flex.items-center.justify-center.hover:bg-[#f2f2f2].dark:hover:bg-[#1a1a1a].hover:border-transparent.font-medium.text-sm.sm:text-base.h-10.sm:h-12.px-4.sm:px-5.w-full.sm:w-auto.md:w-[158px]"],
            purpose: 'Navigational links',
            contextNeeded: [],
            contextCollection: {"search_parents":[".product-card","[data-product]","form"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'IconButton',
            type: 'icon',
            selectors: [".flex.items-center.gap-2",".text-red-500.hover:text-red-700"],
            purpose: 'Cart item removal',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":[".product-card","[data-product]",".cart-item"],"extract_fields":["product-id"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            name: 'QuantitySelector',
            type: 'selector',
            selectors: [".flex.items-center.gap-2"],
            purpose: 'Quantity control for cart items',
            contextNeeded: ["product_id","quantity"],
            contextCollection: {"search_parents":[".cart-item"],"extract_fields":["product-id","quantity"],"sibling_context":[],"data_attributes":["data-product-id","data-quantity"]}
        },

        {
            name: 'LoginForm',
            type: 'form',
            selectors: [".mt-8.space-y-6","#email","#password"],
...

        {
            name: 'RegisterForm',
            type: 'form',
            selectors: [".mt-8.space-y-6","#name","#email","#password","#confirmPassword"],
...

        {
            ...
            purpose: 'Product promotion carousel',
...

        {
            name: 'CartPage',
            type: 'custom',
            selectors: [".flex.gap-4.bg-white.p-4.rounded-lg.shadow.mb-4",".p-1.hover:bg-gray-100.rounded",".font-semibold"],
...

        {
            name: 'CheckoutPage',
            type: 'custom',
            selectors: [".space-y-4","#firstName","#lastName","#email","#phone","#address","#city","#state","#zipCode","#country"],
            purpose: 'Checkout process',
            contextNeeded: ["shipping_info"],
            contextCollection: {"search_parents":["form"],"extract_fields":["shipping_info"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'PaymentPage',
            type: 'custom',
            selectors: [".space-y-4","#cardNumber","#cardName","#expiryDate","#cvv"],
            purpose: 'Payment processing',
            contextNeeded: ["payment_info"],
            contextCollection: {"search_parents":["form"],"extract_fields":["payment_info"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'SuccessPage',
            type: 'custom',
            selectors: [".block.w-full.bg-blue-600.text-white.py-3.rounded-lg.hover:bg-blue-700.transition-colors",".block.w-full.border.border-gray-300.py-3.rounded-lg.hover:bg-gray-50.transition-colors"],
            purpose: 'Post-purchase actions',
            contextNeeded: ["order_id"],
            contextCollection: {"search_parents":[".order-summary"],"extract_fields":["order-id"],"sibling_context":[],"data_attributes":["data-order-id"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-01-4c9z00jrfhm');
