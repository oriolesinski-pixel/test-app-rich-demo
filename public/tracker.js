(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-01-2mzxqhwrik6',
      ...
      this.componentDetectors = [
...

        {
            name: 'IconButton',
            type: 'icon',
            selectors: ["[aria-label]","[data-action]"],
            purpose: 'Triggering actions with icons',
            contextNeeded: [],
            contextCollection: {"search_parents":["[aria-label]","[data-action]"],"extract_fields":["aria-label","data-action"],"sibling_context":[],"data_attributes":["aria-label","data-action"]}
        },

        {
            ...
            contextCollection: {"search_parents":["[data-action=\"update-quantity\"]","[data-product-id]"],"extract_fields":["product-id"],"sibling_context":[],"data_attributes":["data-action","data-product-id"]}
        },

        {
            ...
            type: 'form',
            selectors: ["form"],
            purpose: 'Handling user input and form submissions',
...

        {
            ...
            purpose: 'Capturing user input',
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["input","textarea","select"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'AuthButton',
            type: 'button',
            selectors: ["[data-action=\"login\"]","[data-action=\"register\"]","[data-action=\"logout\"]"],
            purpose: 'Handling user authentication',
            contextNeeded: ["email","password"],
            contextCollection: {"search_parents":["[data-action=\"login\"]","[data-action=\"register\"]","[data-action=\"logout\"]"],"extract_fields":["email","password"],"sibling_context":[],"data_attributes":["data-action"]}
        },
...

        {
            ...
            contextNeeded: ["cart_items","cart_count"],
            contextCollection: {"search_parents":["[href=\"/cart\"]"],"extract_fields":["cart_items","cart_count"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'WishlistButton',
            type: 'icon',
            selectors: ["[href=\"/wishlist\"]"],
            purpose: 'Navigating to the wishlist',
            contextNeeded: ["wishlist_items"],
            contextCollection: {"search_parents":["[href=\"/wishlist\"]"],"extract_fields":["wishlist_items"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-01-2mzxqhwrik6');
