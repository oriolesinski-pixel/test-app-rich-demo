(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-01-h585pe3pe2v',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":["button","[role=\"button\"]","[data-action]"],"extract_fields":[],"sibling_context":[],"data_attributes":["data-action","onClick"]}
        },

        {
            ...
            contextCollection: {"search_parents":["form"],"extract_fields":["form_data"],"sibling_context":[],"data_attributes":["type"]}
        },

        {
            ...
            contextCollection: {"search_parents":["form"],"extract_fields":["selected_state"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            purpose: 'Quantity control for products',
...

        {
            ...
            purpose: 'Adding products to wishlist',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-product-id]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-product-id","data-action"]}
        },

        {
            ...
            purpose: 'Adding products to cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["[data-product-id]"],"extract_fields":["product_id"],"sibling_context":[],"data_attributes":["data-product-id","data-action"]}
        },
...

        {
            ...
            contextCollection: {"search_parents":["form[onSubmit^='handleSubmit']"],"extract_fields":["shipping_info"],"sibling_context":[],"data_attributes":["onSubmit"]}
        },

        {
            ...
            contextCollection: {"search_parents":["form[onSubmit^='handleSubmit']"],"extract_fields":["payment_info"],"sibling_context":[],"data_attributes":["onSubmit"]}
        },

        {
            ...
            contextNeeded: ["carousel_index"],
            contextCollection: {"search_parents":["[data-carousel]"],"extract_fields":["carousel_index"],"sibling_context":[],"data_attributes":["data-carousel"]}
        },

        {
            name: 'Logout Button',
            type: 'button',
            selectors: ["[onClick^='logout']"],
            purpose: 'User logout',
            contextNeeded: [],
            contextCollection: {"search_parents":["[onClick^='logout']"],"extract_fields":[],"sibling_context":[],"data_attributes":["onClick"]}
        },

        {
            name: 'Mobile Menu Toggle',
            type: 'button',
            selectors: ["[onClick^='setMobileMenuOpen']"],
            purpose: 'Toggling mobile menu',
            contextNeeded: ["mobile_menu_state"],
            contextCollection: {"search_parents":["[onClick^='setMobileMenuOpen']"],"extract_fields":["mobile_menu_state"],"sibling_context":[],"data_attributes":["onClick"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-01-h585pe3pe2v');
      console.log('📊 Tracking 14 discovered components');
